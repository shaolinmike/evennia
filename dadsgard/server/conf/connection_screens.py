...
CONNECTION_SCREEN = \
"""
         BEYOND OUR SEGMENT OF TIME AND SPACE, THERE EXISTS {bASGARD{n,
         THE CITADEL OF THE NORSE GODS, WHICH IS CONNECTED TO EARTH BY
                  A RAINBOW BRIDGE CALLED {bBIFROST!{n
